...
average_life_expectancy = df.groupby(['age_group', 'diabetes'])['life_expectancy'].mean().unstack()
...
ax.set_title('Expectativa de Vida Promedio por Rango de Edad: Diabéticos vs No Diabéticos', fontsize=15)
ax.set_xlabel('Rango de Edad', fontsize=12)
ax.set_ylabel('Expectativa de Vida Promedio', fontsize=12)
ax.legend(['No Diabéticos', 'Diabéticos'], title='Diabetes')
...
plt.tight_layout()
plt.savefig('expectativa_vida_diabetes.png', format='png', dpi=300)
